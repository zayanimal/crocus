...
export const setPosition = createAction(
  "[ADMIN] USER_ADD_SET_POSITION"
)<string>();

export const setIsActive = createAction(
  "[ADMIN] USER_ADD_SET_IS_ACTIVE"
)<boolean>();
