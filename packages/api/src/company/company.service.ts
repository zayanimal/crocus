...
export class CompanyService {
   ...
   */
  search(name: string) {
    return this.companyRepository.searchName(name);
  }
   ...
   */
  searchId(id: string) {
    return this.companyRepository.searchId(id);
  }
  ...
  list(page: number, limit: number) {
    return from(paginate(this.companyRepository.list(), { page, limit })).pipe(
  ...
  getFullCompany(id: string) {
    return this.companyRepository.getFullCompany(id);
  }
